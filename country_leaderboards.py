...
class country_leaderboard(commands.Cog):
    ...
    @commands.slash_command(name="country", description="test", guild_ids=[923764211845312533])
    async def country(self, ctx):
        pass



    @country.sub_command(name="leaderboards", description="Search country (or global) leaderboards", guild_ids=[923764211845312533])
    ...
    @country.sub_command(name="track", description="Add players from country (or global) leaderboards", guild_ids=[923764211845312533])
